...
3. **feature-spec-writing** - Individual feature specifications
4. **feature-spec-reviewing** - Feature spec audits
5. **technical-spec-writing** - Technical design documents
6. **technical-spec-reviewing** - Technical spec audits
...
3. **Break into Features** (feature-spec-writing skill)
   - One spec per major feature
   - Include acceptance criteria

4. **Technical Design** (technical-spec-writing skill)
